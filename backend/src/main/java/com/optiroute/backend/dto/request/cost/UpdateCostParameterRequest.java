...
public record UpdateCostParameterRequest(CostParameterCategoryType category, String label, BigDecimal value, CostParameterUnitType unit, boolean active, CostRuleRequest rule) {
}